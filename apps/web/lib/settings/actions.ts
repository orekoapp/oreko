...
export async function getIntegrations(): Promise<IntegrationData[]> {
  return [
    ...
    },
    {
      ...
      name: 'Zapier',
      provider: 'zapier',
      description: 'Connect Oreko to 5,000+ apps using Zapier. Set up a webhook in Oreko and use it as a Zapier trigger.',
      isConnected: false,
      isAvailable: true,
      connectedAt: null,
      config: {},
    },
    {
      ...
      name: 'n8n',
      provider: 'n8n',
      description: 'Build powerful self-hosted automations with n8n. Use Oreko webhooks as triggers in your n8n workflows.',
      isConnected: false,
      isAvailable: true,
      connectedAt: null,
      config: {},
    },
    {
      ...
      provider: 'make',
      description: 'Create visual automation scenarios with Make. Connect Oreko events to hundreds of services via webhooks.',
      isConnected: false,
      isAvailable: true,
      connectedAt: null,
      config: {},
