            ...
            <div className="p-4 flex-1">
              ...
              >
                ...
                <div className="px-6 pb-4 pt-2 space-y-2">
                  ...
                  <button
                    disabled
                    className="w-full h-10 rounded-lg font-medium text-sm flex items-center justify-center gap-2 transition-colors border border-border text-muted-foreground opacity-50 cursor-not-allowed"
                    title="Save the quote first to download PDF"
                  >
